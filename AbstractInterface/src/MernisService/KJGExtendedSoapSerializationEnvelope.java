...
public class KJGExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(KJGDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new KJGStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static KJGDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static KJGDateTimeConverter dateTimeConverter = new KJGStandardDateTimeConverter();

    public KJGExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public KJGExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new KJGMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=KJGHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,KJGExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=KJGHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
