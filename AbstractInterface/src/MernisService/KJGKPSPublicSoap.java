...
public class KJGKPSPublicSoap
{
    ...
    public KJGKPSPublicSoap(){}

    public KJGKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public KJGKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        KJGExtendedSoapSerializationEnvelope envelope= new KJGExtendedSoapSerializationEnvelope(KJGExtendedSoapSerializationEnvelope.VER11);
